  ...
  return (
    <main className="workbench">
      <header className="project-heading">
        ...
        <p>A fly-connectome-based neural controller trained to trace drawings with a simulated foreleg.</p>
        <nav aria-label="About this project">
          ...
          <a href="https://youtu.be/ekJNq7rWOOA" target="_blank" rel="noopener noreferrer"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="5" width="20" height="14" rx="4" /><path d="m10 9 5 3-5 3Z" fill="currentColor" stroke="none" /></svg>Youtube Demo<ArrowUpRight aria-hidden="true" /></a>
